...
export const env = {
  ...
  localDataDir: process.env.LOCAL_DATA_DIR || (process.env.VERCEL ? '/tmp/image-gallery' : './.local-data'),
  publicApiBaseUrl: process.env.PUBLIC_API_BASE_URL || (process.env.VERCEL ? '/api' : 'http://localhost:8080/api'),
